...
export default async function Home() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#1E1B4B]">Dashboard FinOps</h1>
        <p className="text-[#475569] mt-1">Analyse des coûts AWS — {month}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-white rounded-xl p-6 border border-[#E0E7FF]">
          ...
          <p className="text-3xl font-bold text-[#1E1B4B]">${costs.total.toFixed(2)}</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-[#E0E7FF]">
          ...
          <p className="text-3xl font-bold text-[#1E1B4B]">${avgPerDay.toFixed(2)}</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-[#E0E7FF]">
          ...
          <p className="text-3xl font-bold text-[#1E1B4B]">{teamData.length}</p>
        </div>
      </div>
